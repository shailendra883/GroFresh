        ...
        <div class="container py-5" style="margin-left:40rem;">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <a href="index.php" class="logo"><img src ="seller/img/logo.png" style="height:8rem; width:8rem; margin-top:-1.5rem; margin-left:-1rem;"><span style="font-size:2rem;"><b>Gro-Fresh</b></span><em> </em></a>
